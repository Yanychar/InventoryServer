...
import com.c2point.tools.InventoryContextListener;
...
public class DataFacade {
	 ...
	 */
	public <T extends SimplePojo> T insert(T pojo) {
	...
	/**
	 * USE WITH CAUSION. You should use SimplePojo.find() unless your certain
	 * what your doing.
	 * 
	 * @param <T>
	 * @param c
	...
	public <T extends SimplePojo> T refresh(T c) {
		if (c != null && c.getId() > 0 ) {
			EntityManager em = createEntityManager();
			try {
				em.getTransaction().begin();
	 ...
	 */
	public void remove(SimplePojo pojo) {
	...
	public EntityManager createEntityManager() {
		EntityManagerFactory emf = InventoryContextListener.getEntityManagerFactory();
	...
	public void sortById(List<SimplePojo> questions) {
		Collections.sort(questions, new Comparator<SimplePojo>() {
			@Override
			public int compare(SimplePojo arg0, SimplePojo arg1) {
