...
public class NewToolsListModel extends AbstractModel {

	private static Logger logger = LogManager.getLogger( NewToolsListModel.class.getName());
	...
	public NewToolsListModel() {
		
		this( null );
		
	}
	
	public NewToolsListModel( Organisation org ) {
		super();
