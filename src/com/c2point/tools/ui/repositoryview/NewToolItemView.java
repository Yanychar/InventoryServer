...
public class NewToolItemView extends FormLayout implements ToolItemChangedListener {
	private static final long serialVersionUID = 1L;
	private static Logger logger = LogManager.getLogger( NewToolItemView.class.getName());
	...
	public NewToolItemView( NewToolsListModel model ) {
		super();
