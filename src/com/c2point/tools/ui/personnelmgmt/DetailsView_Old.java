...
public class DetailsView_Old extends VerticalLayout implements StuffChangedListener, EditInitiationListener {
	private static final long serialVersionUID = 1L;
	private static Logger logger = LogManager.getLogger( DetailsView_Old.class.getName());
...
//	private TextField	code;
	...
	public DetailsView_Old( StuffListModel model ) {
		super();
